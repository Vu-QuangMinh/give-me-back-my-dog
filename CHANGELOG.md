...
Để xem chi tiết từng commit, dùng `git log` hoặc xem trên GitHub
[port-3d branch](https://github.com/Vu-QuangMinh/give-me-back-my-dog/tree/port-3d).
...
### Gitignore exported binaries (2026-04-28)
...
### Remove 2D leftover files (2026-04-28)
...
### Mốc 9: Floor scenarios + transition modals (2026-04-28)
...
### Mốc 8.3: Bouncing projectile + grapple + aim mode + polish (2026-04-28)
...
### Mốc 7 + 8 partial: Sonny charge bar + bomb, Mike timing bar, .glb models (2026-04-28)
...
### Mốc 6 polish: damage popups, death animations, attack telegraph (2026-04-28)
...
### Mốc 6: Combat melee + DodgeBar 3D (2026-04-28)
...
### Ignore .claude session artifacts (2026-04-28)

**chore:** thêm `.claude/` vào `.gitignore`. `.godot/` và `/android/` đã có sẵn.

### Mốc 1-5: 3D port + complete HUD (2026-04-27)
...
Giữ version 2D gốc làm reference. 3 commit gốc (`Initial commit`,
`play tested`, `04/26/2026`). Branch `port-3d` là version 3D hoàn chỉnh
(mục tiêu chính).
